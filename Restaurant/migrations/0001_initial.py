# Generated by Django 3.2.9 on 2022-01-07 20:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True)),
                ('menu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='menu_orderitem', to='Restaurant.menu')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.IntegerField()),
                ('customer', models.ManyToManyField(related_name='customer_address', to='accounts.Customer')),
            ],
        ),
    ]
